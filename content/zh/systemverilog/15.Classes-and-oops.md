...
|[8.Constant class properties](https://github.com/muneeb-mbytes/SystemVerilog_Course/wiki/15.Classes-and-oops#constant-class-properties)|To make class properties read-only, a const specifier is used|
