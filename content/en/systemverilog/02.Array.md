...
|---|------------------------------------------ | -------------------------------------------------------------------------------------|
1|[Packed Array](https://github.com/muneeb-mbytes/SystemVerilog_Course/wiki/02.Array#1packed-arrays) | Dimension of array declared before array name declaration |       
2|[Unpacked Array](https://github.com/muneeb-mbytes/SystemVerilog_Course/wiki/02.Array#2unpacked-arrays) | Dimension of the array declared after array name declaration | 
3|[Dynamic Array](https://github.com/muneeb-mbytes/SystemVerilog_Course/wiki/02.Array#3dynamic-arrays) | Memories will be allocated at run time |
4|[Associative Array](https://github.com/muneeb-mbytes/SystemVerilog_Course/wiki/02.Array#4associative-arrays) | Memories allocated only when it is used and any index type is used for indexing the array |
5|[Queue](https://github.com/muneeb-mbytes/SystemVerilog_Course/wiki/02.Array#5queue) | It is similar to fifo and we can add and remove elements from queue at run time |
6 | [Array Manipulation Methods](https://github.com/muneeb-mbytes/SystemVerilog_Course/wiki/02.Array#6array-manipulation-method) | It consist of array locator method, Array ordering method and Array Reduction method  |
...
**Github lab code link:-** https://github.com/muneeb-mbytes/SystemVerilog_Course/blob/production/data_type/sv_arrays/packed_array/single_packed/packed_array.sv

**Github lab output link:-** https://github.com/muneeb-mbytes/SystemVerilog_Course/blob/production/data_type/sv_arrays/packed_array/single_packed/packed_array.log
...
**Github lab code link:-** https://github.com/muneeb-mbytes/SystemVerilog_Course/blob/production/data_type/sv_arrays/packed_array/multi_packed/multi_packed.sv

**Github lab output link:-** https://github.com/muneeb-mbytes/SystemVerilog_Course/blob/production/data_type/sv_arrays/packed_array/multi_packed/multi_packed.log
...
**Github lab code link:-** https://github.com/muneeb-mbytes/SystemVerilog_Course/blob/production/data_type/sv_arrays/unpacked_array/single_unpacked/unpacked.sv

**Github lab output link:-** https://github.com/muneeb-mbytes/SystemVerilog_Course/blob/production/data_type/sv_arrays/unpacked_array/single_unpacked/unpacked_array.log
...
**Github lab code link:-** https://github.com/muneeb-mbytes/SystemVerilog_Course/blob/production/data_type/sv_arrays/unpacked_array/multi_unpacked/multi_unpacked.sv

**Github lab output link:-** https://github.com/muneeb-mbytes/SystemVerilog_Course/blob/production/data_type/sv_arrays/unpacked_array/multi_unpacked/multi_unpacked.log
...
**Github lab code link:-** https://github.com/muneeb-mbytes/SystemVerilog_Course/blob/production/data_type/sv_arrays/dynamic_array/dynamic/dynamic.sv

**Github lab output link:-** https://github.com/muneeb-mbytes/SystemVerilog_Course/blob/production/data_type/sv_arrays/dynamic_array/dynamic/dynamic_array.log
...
**Github lab code link:-** https://github.com/muneeb-mbytes/SystemVerilog_Course/blob/production/data_type/sv_arrays/dynamic_array/dynamic_method/methods.sv

**Github lab output link:-** https://github.com/muneeb-mbytes/SystemVerilog_Course/blob/production/data_type/sv_arrays/dynamic_array/dynamic_method/methods_dynamic.log  
...
**Github lab code link:** https://github.com/muneeb-mbytes/SystemVerilog_Course/blob/production/data_type/sv_arrays/dynamic_array/dynamic_unbound/dynamic.sv

**Github lab output link:** https://github.com/muneeb-mbytes/SystemVerilog_Course/blob/production/data_type/sv_arrays/dynamic_array/dynamic_unbound/dynamic.log
